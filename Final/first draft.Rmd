...
```{r, echo=FALSE}
# store the frequency table for ideology, in reverse order
...
```{r, echo=FALSE}
# Store the frequency table for votes, in descending order
...
voted2_refused_count <- rev(sort(table(ideology_by_refused_voted2$ideology)))
